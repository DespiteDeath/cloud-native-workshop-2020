...
### Health check
 ...
 Мы можем перепроверить это, снова запросив сведения по заказам кофе, аналогично предыдущему. Однако теперь возвращенный массив должен содержать JSON файл, с информацмией о нашем заказе.
